# Generated by Django 4.2.20 on 2025-06-04 06:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children_status1', models.CharField(default='pending', help_text='children_status', max_length=50)),
                ('children_status2', models.CharField(default='pending', help_text='children_status', max_length=50)),
                ('children_qrcode', models.ImageField(blank=True, null=True, upload_to='media/')),
            ],
            options={
